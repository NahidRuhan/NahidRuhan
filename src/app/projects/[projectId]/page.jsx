...
import { ArrowLeft, ExternalLink, Code2, AlertTriangle, Lightbulb } from "lucide-react";
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${project.name} - Nahid Pervej Ruhan`,
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-background">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <Link href="/#projects" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors mb-12 font-mono text-sm uppercase tracking-wider">
        ...
        <div className="glass rounded-3xl p-6 sm:p-10 mb-12 border border-border/50 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center relative z-10">
            <div className="w-full md:w-1/2 shrink-0 rounded-2xl overflow-hidden bg-muted/20 border border-border/50 shadow-2xl relative h-64 md:h-96">
              <Image src={project.image} alt={project.name} fill sizes="(max-width: 768px) 100vw, 50vw" priority className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
